<head>
    ...
    <title>SMITE</title>
    <link rel="icon" type="image/png" href="http://telkominfra.co.id/wp-content/uploads/2016/08/telkominfra-logo.jpg">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/plzz.css">
        ...
        <form action="<?php echo site_url('logincontroller/cek_login') ?>" method="post">
            <div id="plis">
                <span id="center" style="color:white;letter-spacing:8px;">
                    SMITE<br>
                    <p style="font-size:20px; font-weight:normal; text-transform:none;letter-spacing:2px;">Site Monitoring for Telkom Infra</p>
                </span>
            </div>
            <div id="form">
