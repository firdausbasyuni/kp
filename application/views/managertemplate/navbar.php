<header>
    <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav bg-light" style="height:60px;">
        ...
        <div class="breadcrumb-dn mr-auto">
            <a class="navbar-brand" href="<?php echo site_url('managerController/index'); ?>"><img src="http://sharedvis.co.id/assets/front/images/corporate/client/telkominfra.png" style="height:40px;"></a>
        </div>
                ...
                <ul class="dropdown-menu" style="text-align:center;">
                    ...
                    <li class="user-header">
                        ...
                        <p style="text-decoration:no;">
                            <?php echo $this->session->userdata('nama'); ?><br>Manager
                        </p>
                    </li>
                    <!-- Menu Footer-->
    ...
    <?php $this->load->view('managertemplate/sidebar') ?>
</header>