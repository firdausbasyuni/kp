...
<body class="fixed-sn pink-skin" style="margin-left:160px; margin-top:40px;">
      ...
      <div style="margin-left:40px; margin-top:40px;">
            <div class="row" style="padding-top: 12px;  margin-right:4px; margin-left:4px;">
                  <div class="col" style="padding-top:16px;">
                              ...
                              <tbody>
                                    ...
                                    if ($data) {
                                          foreach ($data as $d) { ?>
                                                ...
                                                <td><?php echo $no++ ?></td>
                                                <td><?php echo $d->namaopt ?>
                                                <td><?php echo $d->nama ?></td>
                                                <td><?php echo $d->tanggal ?></td>
                                                <td><?php echo $d->discription ?></td>
                                                <td><?php echo $d->balas ?></td>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#reportuser">
                              Input Report
                        </button>
