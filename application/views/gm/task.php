            ...
            if ($stask) {
              foreach ($stask as $s) { ?>
                <tr>
                  ...
                  <td>
                    <?php if ($s->apro_manager == TRUE) {
                      echo '<a href="' . site_url('gmController/lakukan_download/') . $s->nama_file . '"class="btn  btn-primary fa fa-trash-o">Download laporan</a>';
                    } else {
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="<?php echo site_url('GmController/detailtask') ?>">
                    <div class="form-group">
                      <input type="hidden" name="id_task" value="<?php echo $dt->id_task; ?>">
                      <?php if ($dt->apro_manager == true) {
                        $lap =  'Telah diacc oleh manager';
                      } else {
                        $lap = 'Belum ada laporan dari user atau belum diacc oleh manager';
                      } ?>
