...
class ManagerController extends CI_Controller
{
  ...
  public function transaction()
  {
    ...
    $this->load->view('manager/transaction', $data);
  }
  ...
  public function inventory()
  {
    ...
    $this->load->view('manager/inventory', $data);
  }

  public function task()
  {
    $data['page'] = 'task';
    $data['stask'] = $this->MainModel->showtaskmanager();
    $data['site'] = $this->MainModel->getsite();
    $data['operator'] = $this->MainModel->getopt();
    $this->load->view('managertemplate/header');
  ...
  public function create()
  {
    ...
    redirect("ManagerController/task");
  }
  ...
  public function delete($id)
  {
    ...
    redirect(site_url('ManagerController/task'));
  }
  public function detailtask()
  {
    $id = $this->input->post('id_task');
    $update = array(
      'keadaan' => 'Menunggu Aproval GM',
      'apro_manager' => TRUE
    );
  ...
  public function tambah()
  {
    ...
    redirect('ManagerController/inventory');
  }

  public function delDatakel($id)
  {
    $this->MainModel->deletekel($id);
    redirect('ManagerController/report');
  }
  ...
  public function insert_trans()
  {
    ...
    redirect('ManagerController/transaction');
  }
